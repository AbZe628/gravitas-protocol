  ...
  return (
    <div className="min-h-screen bg-[#060E1A] text-white overflow-x-hidden">
        ...
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          <Link href="/">
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              <span className="font-bold text-lg tracking-tight hidden sm:inline">Gravitas Protocol</span>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-6 text-sm text-white/60">
              {navLinks.map((link) => (
                <Link key={link.href} href={link.href} className="hover:text-[#D4AF37] transition-colors cursor-pointer">
                  {link.label}
                </Link>
              ))}
              <a
            ...
            <div className="container px-4 py-4 space-y-3">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="block px-4 py-2 text-white/60 hover:text-[#D4AF37] hover:bg-[#D4AF37]/10 rounded-lg transition-colors"
                >
                  {link.label}
                </Link>
              ))}
      ...
      <section className="relative min-h-screen flex items-center pt-20 md:pt-16">
        ...
        <div className="container relative z-10 py-12 md:py-24 px-4 md:px-6">
          <motion.div
            variants={stagger}
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-[1.05] mb-6 tracking-tight">
              Institutional-Grade
              <br />
            ...
            <motion.p variants={fadeUp} className="text-base md:text-lg lg:text-xl text-white/60 mb-10 max-w-2xl leading-relaxed">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row flex-wrap gap-4 mb-16">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-6 text-xs md:text-sm w-full md:w-auto">
              <a
                ...
                className="flex items-center gap-2 text-white/60 hover:text-[#D4AF37] transition-colors truncate"
              >
                <span className="font-mono text-xs">PolicyRegistry: 0xbcaE...4679</span>
              ...
              <a
                ...
                className="flex items-center gap-2 text-white/60 hover:text-[#D4AF37] transition-colors truncate"
              >
                <span className="font-mono text-xs">TeleportV3: 0x5D42...E993</span>
                <ExternalLink className="h-3 w-3 shrink-0" />
              </a>
            </div>
          </div>
      ...
      <section className="py-16 md:py-32">
        <div className="container px-4 md:px-6">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
          ...
          >
            {[
              ...
              },
              {
                icon: Cpu,
                title: "Gas Optimized",
                description: "Yul inline assembly optimization for dust refunds saves ~2,000 gas per migration, providing best-in-class capital efficiency.",
                badge: "Yul Optimized",
              },
              {
                icon: Network,
                title: "Deterministic Routing",
                description: "Simulation APIs provide exact outcomes before execution, eliminating uncertainty and ensuring transparency for institutional reporting.",
                badge: "Transparent",
              },
            ].map((feature, i) => (
              <motion.div key={i} variants={fadeUp}>
                <Card className="h-full border-[#D4AF37]/10 bg-[#0A1628]/40 hover:border-[#D4AF37]/30 transition-all group">
                  <CardHeader>
                    <div className="h-12 w-12 rounded-xl bg-[#D4AF37]/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                      <feature.icon className="h-6 w-6 text-[#D4AF37]" />
                    </div>
                    <Badge className="w-fit mb-2 bg-white/5 border-white/10 text-white/40 text-[10px] uppercase tracking-widest">{feature.badge}</Badge>
                    <CardTitle className="text-lg md:text-xl text-white group-hover:text-[#D4AF37] transition-colors">{feature.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
      ...
      <section className="py-16 md:py-32 relative overflow-hidden">
        <div className="absolute inset-0 bg-[#D4AF37]/5 blur-[120px] rounded-full -translate-y-1/2" />
        <div className="container relative z-10 px-4 md:px-6">
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl lg:text-6xl font-bold mb-6">
              The Future of
              <br />
            ...
            <motion.p variants={fadeUp} className="text-base md:text-lg lg:text-xl text-white/50 mb-10 max-w-2xl mx-auto">
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center">
              <Button asChild size="lg" className="bg-[#D4AF37] text-[#060E1A] hover:bg-[#D4AF37]/90 font-semibold gap-2 px-8 md:px-10 h-12 md:h-14 text-base md:text-lg shadow-2xl shadow-[#D4AF37]/20">
                <Link href="/dashboard">
                  Launch Dashboard
                  <ArrowRight className="h-5 w-5" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-[#D4AF37]/30 text-white hover:bg-[#D4AF37]/10 gap-2 px-8 md:px-10 h-12 md:h-14 text-base md:text-lg">
                <a href="https://github.com/AbZe628/gravitas-protocol" target="_blank" rel="noopener noreferrer">
                  <Github className="h-5 w-5" />
                  View on GitHub
                </a>
