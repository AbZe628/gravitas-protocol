...
export class UniV2Adapter extends BaseAdapter {
  private iface = new Interface(UNIV2_ROUTER_ABI);

  constructor(routerAddress: string, supportedChains: number[]) {
    super({
      adapterId: "uniswap_v2",
      routerAddress,
      supportedChains
    });
  }
  ...
  getQuote(liquidityAmount: bigint, reservesA: bigint, reservesB: bigint, totalSupply: bigint): { amountA: bigint; amountB: bigint } {
    ...
    // Standard V2 Formula: (Amount * Reserves) / TotalSupply
